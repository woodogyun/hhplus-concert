package kr.hhplus.be.server.api.queue.application.scheduler;
...
public class QueueScheduler {
    ...
    public void manageQueue() {
        ...
        if (activeQueueCount < maxQueueCapacity) {
            ...
            int updateTokenCount = queueService.updateToken(queuesToUpdate, policyProperties.getExpirationSeconds()); // 최신 순번 변경 로직 호출
